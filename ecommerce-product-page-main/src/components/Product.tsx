  ...
  return (
    <div className="flex flex-row justify-between mt-20">
      ...
      <section className="max-w-[480px]">
        <h3 className="text-orange-400 uppercase">Sneaker Company</h3>
        ...
        <div className="flex flex-row space-x-3">
          <div className="flex flex-col">
            <h4 className="text-4xl">$125.00</h4>
            <h5 className="text-2xl text-gray-400 line-through line-sth">
              $250.00
            </h5>
          </div>
          <div className="bg-orange-100 rounded h-6 px-1 text-orange-600">
            50%
          </div>
        </div>
        <div className="flex flex-row space-x-5 my-6">
          <div className="flex flex-row bg-gray-200 space-x-6 px-5 rounded-lg">
            <div className="text-orange-400 m-auto text-3xl pb-1">-</div>
            <div className="m-auto">0</div>
            <div className="text-orange-400 m-auto text-3xl pb-1">+</div>
          </div>
          <button className="bg-orange-400 text-white flex flex-row space-x-3 justify-center p-4 w-3/5 rounded-lg">
            <IconBasketWhite />
